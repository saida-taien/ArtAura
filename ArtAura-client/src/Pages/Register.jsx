...
const Register = () => {
    ...
    return (
        <div className="container mx-auto border-2 border-[#e65b56] my-10 flex flex-col max-w-md p-6 rounded-md sm:p-10 dark:bg-gray-50 dark:text-gray-800">
            ...
            <form onSubmit={handleRegister} className="space-y-12">
                ...
                <div className="space-y-2">
                    <div>
                        <button type="submit" className="w-full px-8 py-3 font-semibold rounded-md dark:bg-violet-600 dark:text-gray-50 bg-[#e65b56] text-white">Sign in</button>
                    </div>
